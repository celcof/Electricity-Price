...
\textit{Figure~\ref{fig:world_cost}} provides a global picture of the amount spent by households around the world for their electricity bills. Countries are colored on the basis of its price, measured in US dollars per kWh.~\cite{GE}
...
\multicolumn{2}{l}{\scriptsize{$^{***}p<0.001$; $^{**}p<0.01$; $^{*}p<0.05$}}
\end{tabular}
\caption{Fixed Effects (FE) model overall summary.}
\label{Tab:fe}
\end{center}
\end{table}

\textit{Table~\ref{Tab:fef}} instead is just a short summary of performance of the \textit{FE model}.
...
\hline
\end{tabular}
\caption{Fixed Effects (FE) model performance summary.}
\label{Tab:fef}
\end{center}
\end{table}
\bigskip
